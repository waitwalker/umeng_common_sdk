              ...
              child: Column(
                  ...
                  children: <Widget>[
                    TextButton(
                        ...
                        child: Text(
                            "onEvent(bool, {name:jack, age:18, male:true})"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                          UmengCommonSdk.onEvent('bool',
                              {'name': 'jack', 'age': 18, 'male': true});
                        }),
                    TextButton(
                        style: ButtonStyle(
                          backgroundColor:
                        ...
                        child: Text(
                            "onEvent(float, {name:jack, age:18, degree:1.6})"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                          UmengCommonSdk.onEvent('float',
                    ...
                    TextButton(
                        ...
                        child: Text(
                            "onEvent(long, {name:jack, age:18, mobile:13910012345})"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                          UmengCommonSdk.onEvent('long', {
                            'name': 'jack',
                            'age': 18,
                            'mobile': 8613910012345
                          });
                        }),
                    TextButton(
                        style: ButtonStyle(
                        ...
                        child: Text(
                            "onEvent(array, {name:jack, age:18, children:[tom, jerry]})"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                          UmengCommonSdk.onEvent('array', {
                            'name': 'jack',
                            'age': 18,
                            'male': true,
                            'mobile': 13910012345,
                    ...
                    TextButton(
                        ...
                        child: Text(
                            "onEvent(map, {name:jack, age:18, work:{2000:TC, 2005:BAIDU, 2010:ALI}})"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                    ...
                    TextButton(
                        ...
                        child: Text(
                            "onEvent(null, {name:jack, age:18, like:null })"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                          UmengCommonSdk.onEvent('null',
                              {'name': 'jack', 'age': 18, 'like': null});
                        }),
                    TextButton(
                        style: ButtonStyle(
                          backgroundColor:
                        ...
                        child: Text(
                            "onEvent(map_array, {name:jack, age:18, work:{2000:TC, 2005:BAIDU, 2010:ALI}, children:[tom, jerry]})"),
                        // shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
                        onPressed: () {
                          UmengCommonSdk.onEvent('map_array', {
                            'name': 'jack',
                            'age': 18,
                            'children': ['tom', 'jerry'],
                            'work': {
